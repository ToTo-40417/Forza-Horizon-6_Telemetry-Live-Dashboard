...
let data=null,lastRx=0,rxCount=0,lastHzAt=performance.now(),ageAvg=0,cam={yaw:.62,pitch:-.46,dist:9.6,scale:.82,drag:false,x:0,y:0},smooth={speed:0,rpm:0,roll:0,pitch:0,yaw:0,steer:0,lat:0,long:0},track=[],origin=null;
function hexRgb(c){const n=parseInt(c.slice(1),16);return[(n>>16)&255,(n>>8)&255,n&255].join(',')}
