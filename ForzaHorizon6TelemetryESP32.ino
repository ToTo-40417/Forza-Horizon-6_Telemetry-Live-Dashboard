...
<div class="hud">
  ...
  <section class="right"><div class="panel"><div class="label">Tire Slip State</div><div class="tires"><div class="tire"><div class="tireTop"><span class="label">FL</span><span id="flTemp" class="temp">0.0℃</span></div><div id="flSlip" class="slipMain">0.00</div><div class="slipBar"><i id="flSlipBar"></i></div><div class="slipMeta"><span>Ratio <b id="flRatio">0.00</b></span><span>Angle <b id="flAngle">0.00</b></span></div><div class="wet"><i id="flWet"></i></div></div><div class="tire"><div class="tireTop"><span class="label">FR</span><span id="frTemp" class="temp">0.0℃</span></div><div id="frSlip" class="slipMain">0.00</div><div class="slipBar"><i id="frSlipBar"></i></div><div class="slipMeta"><span>Ratio <b id="frRatio">0.00</b></span><span>Angle <b id="frAngle">0.00</b></span></div><div class="wet"><i id="frWet"></i></div></div><div class="tire"><div class="tireTop"><span class="label">RL</span><span id="rlTemp" class="temp">0.0℃</span></div><div id="rlSlip" class="slipMain">0.00</div><div class="slipBar"><i id="rlSlipBar"></i></div><div class="slipMeta"><span>Ratio <b id="rlRatio">0.00</b></span><span>Angle <b id="rlAngle">0.00</b></span></div><div class="wet"><i id="rlWet"></i></div></div><div class="tire"><div class="tireTop"><span class="label">RR</span><span id="rrTemp" class="temp">0.0℃</span></div><div id="rrSlip" class="slipMain">0.00</div><div class="slipBar"><i id="rrSlipBar"></i></div><div class="slipMeta"><span>Ratio <b id="rrRatio">0.00</b></span><span>Angle <b id="rrAngle">0.00</b></span></div><div class="wet"><i id="rrWet"></i></div></div></div></div><div class="panel"><div class="radarGrid"><div class="radarCell"><div class="label">G Vector</div><canvas id="radar" width="150" height="150"></canvas></div><div class="radarCell"><div class="label">Route X/Z</div><canvas id="route" width="150" height="150"></canvas></div></div></div></section>
