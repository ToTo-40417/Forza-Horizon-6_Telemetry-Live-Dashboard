...
@media(min-width:1180px) and (max-width:1300px) and (min-height:1020px) and (max-height:1120px){.brand h1{font-size:42px}.pill{font-size:15px;padding:8px 13px}.iconBtn{width:42px;height:42px;font-size:16px}.label{font-size:12px}.row{font-size:20px}.value{font-size:27px}.mini strong{font-size:24px}.speedbox .readout{position:static}.speedbox .big{font-size:108px;line-height:.78}.speedbox .value{font-size:28px}.unit{font-size:24px}.gear{font-size:82px}.speedbox .rpmbar{width:min(390px,48vw);height:10px}.peakStrip{position:absolute;left:50%;bottom:20%;transform:translateX(-50%);width:min(440px,72%);margin:0}.peakStrip span{font-size:9px}.peakStrip b{font-size:15px}.tire .temp{font-size:25px}.tireMeta{font-size:8px}.dynStats .mini strong{font-size:19px}.foot .mini strong{font-size:24px}}@media(max-width:980px) and (orientation:landscape){.brand h1{font-size:20px}.pill{font-size:8px;padding:4px 6px}.iconBtn{width:24px;height:24px}.label{font-size:6.8px}.row{font-size:9px}.value{font-size:11px}.metric{gap:2px}.metric .label{font-size:7.8px}.metric .row{font-size:11px}.metric .row b{font-size:10.8px}.steerMeta{font-size:7.4px}.mini strong{font-size:11.5px}.speedbox .readout{position:absolute;inset:0;z-index:2;display:block;padding:0}.gauge{top:62%;width:min(96%,255px);z-index:1}.speedbox .readout>.label{position:absolute;top:29%;left:0;right:0;text-align:center;text-shadow:0 1px 0 #041018,0 0 7px rgba(5,9,13,.95)}.speedbox .readout>div:nth-child(2){position:absolute;top:33%;left:0;right:0;text-align:center;z-index:3}.speedbox .big{font-size:47px;line-height:.76;text-shadow:0 1px 0 #041018,0 0 12px rgba(5,9,13,1),0 0 22px rgba(5,9,13,.9)}.speedbox .value{font-size:14px}.unit{font-size:10.5px;text-shadow:0 1px 0 #041018,0 0 10px rgba(5,9,13,1)}.gear{font-size:30px;line-height:.82;text-shadow:0 1px 0 #041018,0 0 8px rgba(5,9,13,.95)}.speedbox .rpmbar{position:absolute;top:47%;left:50%;transform:translateX(-50%);width:min(150px,42vw);height:5px;z-index:3}#speedbox .readout>.row{position:absolute;top:51%;left:50%;transform:translateX(-50%);min-width:150px!important;width:150px;margin-top:0!important;grid-template-columns:minmax(0,1fr) auto;align-items:center;z-index:3}.peakStrip{position:absolute;left:50%;bottom:13%;transform:translateX(-50%);width:min(214px,80%);margin:0;gap:2px}.peakStrip div{padding:2px 2px}.peakStrip span{display:block;font-size:5.5px}.peakStrip b{font-size:8px}.tire .label{font-size:7.8px}.tire .temp{font-size:11.2px}.tireMeta{font-size:6.8px}.dynPanel{grid-template-columns:minmax(0,.88fr) minmax(58px,.76fr);gap:3px}.dynStats{grid-template-columns:1fr;grid-template-rows:repeat(4,minmax(0,1fr));gap:3px}.dynStats .mini{padding:2px 3px}.dynStats .mini .label{font-size:6px}.dynStats .mini strong{font-size:9.2px}.foot .mini strong{font-size:11.5px}}
