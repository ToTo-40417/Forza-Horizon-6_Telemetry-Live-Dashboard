...
@media(max-width:980px) and (orientation:landscape),(min-width:1180px) and (max-width:1300px) and (min-height:1020px) and (max-height:1120px){:root{--dash-pad:clamp(4px,1.05dvh,8px);--dash-gap:clamp(4px,.85dvh,7px);--trace-h:clamp(42px,7.2dvh,78px);--foot-h:clamp(36px,5.7dvh,58px)}body{height:100dvh;min-height:0;overflow:hidden}main{height:100dvh;min-height:0;overflow:hidden;padding:var(--dash-pad);grid-template-rows:clamp(26px,4.2dvh,42px) minmax(0,1fr) var(--trace-h) var(--foot-h);gap:var(--dash-gap)}.top{min-height:0;grid-template-columns:minmax(0,1fr) auto;gap:clamp(5px,.8dvh,8px)}.brand{min-width:0}.brand h1{font-size:clamp(18px,3vw,34px);line-height:1;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.status{gap:clamp(4px,.75dvh,7px);flex-wrap:nowrap;min-width:0}.pill{font-size:clamp(8px,1.05vw,12px);line-height:1;padding:clamp(4px,.75dvh,7px) clamp(6px,.9vw,11px);min-width:auto}.iconBtn{width:clamp(24px,3.35dvh,36px);height:clamp(24px,3.35dvh,36px);font-size:clamp(11px,1.25vw,15px)}.dash{display:grid;grid-template-columns:minmax(0,.88fr) minmax(0,1.55fr) minmax(0,.92fr);gap:var(--dash-gap);min-height:0}.dash>*{min-width:0;min-height:0}.panel{padding:clamp(4px,.8dvh,8px);border-radius:6px}.stack{display:grid;grid-template-rows:minmax(0,1fr) minmax(0,.62fr);gap:var(--dash-gap)}.rightStack{display:grid;grid-template-rows:minmax(0,.84fr) minmax(0,1fr);gap:var(--dash-gap)}.label{font-size:clamp(6.8px,.9vw,10px);line-height:1}.metric{gap:clamp(2px,.4dvh,4px)}.metric .label{font-size:clamp(7px,.92vw,10px)}.row{font-size:clamp(10px,1.35vw,17px);gap:clamp(3px,.55dvh,7px)}.metric .row b{font-size:clamp(10px,1.35vw,17px)}.value{font-size:clamp(13px,1.9vw,24px)}.bar{height:clamp(4px,.78dvh,8px)}.steerwrap{height:clamp(30px,6.1dvh,64px);grid-template-columns:clamp(25px,4.6dvh,48px) minmax(0,1fr);gap:clamp(4px,.75dvh,8px)}.wheel{width:clamp(23px,4.1dvh,44px);height:clamp(23px,4.1dvh,44px);border-width:clamp(3px,.48dvh,5px)}.wheel:before{top:clamp(3px,.65dvh,6px);width:clamp(3px,.55dvh,6px);height:clamp(13px,2.3dvh,24px)}.wheel:after{top:clamp(7px,1.24dvh,13px);width:clamp(14px,2.45dvh,26px);height:clamp(3px,.55dvh,6px)}.steerMeta{font-size:clamp(7px,.9vw,11px)}.steerBar{height:clamp(5px,.9dvh,8px)}.grid2{gap:clamp(4px,.75dvh,7px);grid-template-columns:1fr 1fr;grid-template-rows:repeat(2,minmax(0,1fr))}.mini{padding:clamp(4px,.75dvh,8px);border-radius:6px}.mini strong{font-size:clamp(11px,1.55vw,19px);line-height:1.03;margin-top:2px}.speedbox{min-height:0}.speedbox:before{inset:6% 4%}.speedbox .readout{position:absolute;inset:0;z-index:2;display:block;padding:0}.speedbox .readout>.label{position:absolute;top:24%;left:0;right:0;text-align:center;font-size:clamp(7px,.9vw,11px);white-space:nowrap;text-shadow:0 1px 0 #041018,0 0 10px rgba(5,9,13,.95)}.speedbox .readout>div:nth-child(2){position:absolute;top:28%;left:0;right:0;text-align:center;z-index:4;white-space:nowrap}.speedbox .big{font-size:clamp(50px,8.1vw,106px);line-height:.75;text-shadow:0 1px 0 #041018,0 0 16px rgba(5,9,13,1),0 0 30px rgba(5,9,13,.94)}.unit{font-size:clamp(11px,1.75vw,22px);text-shadow:0 1px 0 #041018,0 0 12px rgba(5,9,13,1)}.gauge{top:55%;width:min(108%,clamp(292px,48vw,470px));z-index:1}.speedbox .rpmbar{position:absolute;top:42%;left:50%;transform:translateX(-50%);width:min(66%,clamp(172px,30vw,380px));height:clamp(5px,.85dvh,9px);z-index:4}.speedbox .value{font-size:clamp(13px,1.95vw,24px)}.gear{font-size:clamp(28px,5.3vw,66px);line-height:.82;text-shadow:0 1px 0 #041018,0 0 10px rgba(5,9,13,.96)}#speedbox .readout>.row{position:absolute;top:49%;left:50%;transform:translateX(-50%);width:min(62%,clamp(158px,27vw,330px))!important;min-width:0!important;margin-top:0!important;grid-template-columns:minmax(0,1fr) auto;gap:clamp(3px,.65dvh,6px);align-items:center;z-index:4}.peakStrip{position:absolute;left:50%;bottom:10%;transform:translateX(-50%);width:min(82%,clamp(218px,36vw,420px));margin:0;gap:clamp(3px,.55dvh,6px)}.peakStrip div{padding:clamp(2px,.45dvh,4px) clamp(3px,.7dvh,6px);border-radius:4px}.peakStrip span{display:block;font-size:clamp(5.8px,.7vw,8px);white-space:nowrap}.peakStrip b{font-size:clamp(8.2px,1.05vw,13px)}.tireMap{height:calc(100% - clamp(8px,1.5dvh,16px));grid-template-columns:minmax(0,1fr) clamp(18px,2.6vw,32px) minmax(0,1fr);gap:clamp(3px,.65dvh,6px)}.tire{padding:clamp(2px,.55dvh,5px);border-radius:5px;grid-template-rows:auto auto auto auto;align-content:space-evenly}.tire .label{font-size:clamp(7px,.9vw,10px)}.tire .temp{font-size:clamp(10.5px,1.65vw,21px);line-height:1;width:5.8ch}.tireMeta{font-size:clamp(5.8px,.7vw,7px)}.tireMeta:nth-of-type(2),.wet{display:none}.slip{height:clamp(3px,.55dvh,5px);margin-top:1px}.carCore{border-radius:10px}.carCore:before{width:clamp(10px,1.55vw,20px);top:clamp(6px,1.1dvh,10px);bottom:clamp(6px,1.1dvh,10px)}.carCore:after{left:3px;right:3px;box-shadow:0 -22px rgba(237,248,255,.16),0 22px rgba(237,248,255,.16)}.tire:after{top:8px;bottom:8px;width:3px}.dynPanel{grid-template-columns:minmax(0,.92fr) minmax(66px,.78fr);gap:clamp(4px,.7dvh,7px)}.dynStats{grid-template-columns:1fr;grid-template-rows:repeat(4,minmax(0,1fr));gap:clamp(3px,.55dvh,5px)}.dynStats .mini{padding:clamp(3px,.55dvh,6px) clamp(4px,.75dvh,7px)}.dynStats .mini .label{font-size:clamp(5.8px,.72vw,8px)}.dynStats .mini strong{font-size:clamp(9px,1.28vw,16px)}.foot{grid-template-columns:1.45fr .8fr .82fr 1fr;gap:var(--dash-gap)}.foot .mini strong{font-size:clamp(10.5px,1.45vw,18px)}canvas{border-radius:6px}#trace{height:100%}}
@media(max-width:980px) and (orientation:landscape),(min-width:1180px) and (max-width:1300px) and (min-height:1020px) and (max-height:1120px){.gauge{top:50%}.speedbox .readout>div:nth-child(2){top:30%}.speedbox .rpmbar{top:41%}#speedbox .readout>.row{top:48%}.peakStrip{bottom:9%}}
...
const dashDemo=new URLSearchParams(location.search).has('test');
...
function demoPacket(now){const t=now/1000,s=Math.sin(t),c=Math.cos(t*.73),br=(Math.sin(t*1.9)+1)*127.5;return{signal:true,race:true,ageMs:18+Math.sin(t*3)*9,speedKmh:Math.max(0,218+118*s),gear:Math.max(1,Math.min(8,Math.round(4+s*3))),rpm:5600+Math.sin(t*2.1)*2500,maxRpm:9000,accel:s>0?255:36,brake:br,clutch:0,handBrake:0,steer:Math.round(Math.sin(t*1.4)*116),powerPs:820*s,torque:980*c,boost:21+8*s,fuel:.76,tireTemp:[82+18*s,79+16*c,73+12*Math.sin(t+.8),72+12*Math.cos(t*.9)],tireSlip:[.4+2.6*Math.abs(s),.3+2.2*Math.abs(c),.25+1.8*Math.abs(Math.sin(t*1.3)),.2+1.7*Math.abs(Math.cos(t*1.1))],puddle:[0,0,0,0],latG:1.8*Math.sin(t*1.25),longG:1.45*Math.cos(t*1.8),rollDeg:8*Math.sin(t*1.25),yawDeg:120*Math.sin(t*.4),carName:'2020 Hennessey Venom F5 Revolution',carOrdinal:0,pi:998,classLabel:'X',drivetrain:2,cylinders:8,carType:'Track Toys',lap:1,position:1,bestLap:0,currentLap:0}}
function connect(){if(dashDemo){el.state.textContent='TEST';el.state.className='pill live';return}const ws=new WebSocket(`ws://${location.hostname}:81/`);ws.onopen=()=>{el.state.textContent='CONNECTED';el.state.className='pill live'};ws.onmessage=e=>{data=JSON.parse(e.data);lastRx=performance.now();rxCount++};ws.onclose=()=>{el.state.textContent='RECONNECTING';el.state.className='pill warn';setTimeout(connect,900)};ws.onerror=()=>ws.close()}
