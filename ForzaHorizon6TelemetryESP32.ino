...
const base=hi?[[-2.55,-.31,-.84],[-2.18,-.34,-1.02],[-1.18,-.38,-1.1],[-.05,-.39,-1.08],[1.08,-.36,-1.04],[1.9,-.31,-.96],[2.34,-.24,-.78],[2.55,-.2,-.52],[2.6,-.18,0],[2.55,-.2,.52],[2.34,-.24,.78],[1.9,-.31,.96],[1.08,-.36,1.04],[-.05,-.39,1.08],[-1.18,-.38,1.1],[-2.18,-.34,1.02],[-2.55,-.31,.84]]:[[-2.58,-.36,-.88],[.55,-.37,-1.02],[2.16,-.28,-.86],[2.72,-.18,-.56],[2.86,-.16,0],[2.72,-.18,.56],[2.16,-.28,.86],[.55,-.37,1.02],[-2.58,-.36,.88]];
const belt=hi?[[-2.42,.11,-.67],[-1.9,.18,-.86],[-1.06,.24,-.9],[-.05,.27,-.88],[.9,.25,-.84],[1.68,.16,-.76],[2.18,.05,-.62],[2.48,.0,-.42],[2.55,-.01,0],[2.48,.0,.42],[2.18,.05,.62],[1.68,.16,.76],[.9,.25,.84],[-.05,.27,.88],[-1.06,.24,.9],[-1.9,.18,.86],[-2.42,.11,.67]]:[[-2.42,.04,-.7],[-.72,.16,-.82],[.82,.16,-.74],[1.95,.04,-.56],[2.5,-.02,-.34],[2.64,-.02,0],[2.5,-.02,.34],[1.95,.04,.56],[.82,.16,.74],[-.72,.16,.82],[-2.42,.04,.7]];
const roof=hi?[[-1.38,.35,-.5],[-.92,.55,-.52],[-.28,.68,-.5],[.42,.66,-.46],[.92,.49,-.4],[1.12,.3,-.32],[1.16,.24,0],[1.12,.3,.32],[.92,.49,.4],[.42,.66,.46],[-.28,.68,.5],[-.92,.55,.52],[-1.38,.35,.5],[-1.58,.26,0]]:[[-1.0,.38,-.36],[-.28,.58,-.34],[.48,.5,-.3],[.72,.28,0],[.48,.5,.3],[-.28,.58,.34],[-1.0,.38,.36]];
...
if(hi){[[-2.05,-.68],[-1.18,-.82],[1.22,-.76],[1.9,-.62]].forEach(p=>strokePath([[p[0],.08,p[1]],[p[0]+.36,.2,p[1]*.96]],`rgba(${css('--accent2-rgb','56,216,255')},.34)`,1.1,false));strokePath([[-1.46,.27,-.78],[-.76,.46,-.84],[.18,.5,-.78],[.92,.33,-.62]],`rgba(${css('--accent2-rgb','56,216,255')},.6)`,1.7,false);strokePath([[-1.46,.27,.78],[-.76,.46,.84],[.18,.5,.78],[.92,.33,.62]],`rgba(${css('--accent2-rgb','56,216,255')},.6)`,1.7,false);strokePath([[-1.42,.31,-.5],[-1.24,.5,-.5],[-.94,.58,-.52]],`rgba(${css('--accent2-rgb','56,216,255')},.48)`,1.5,false);strokePath([[-1.42,.31,.5],[-1.24,.5,.5],[-.94,.58,.52]],`rgba(${css('--accent2-rgb','56,216,255')},.48)`,1.5,false);strokePath([[-2.48,.22,-.58],[-2.1,.3,-.66],[-1.72,.28,-.6]],`rgba(${css('--accent-rgb','88,255,154')},.58)`,1.7,false);strokePath([[-2.48,.22,.58],[-2.1,.3,.66],[-1.72,.28,.6]],`rgba(${css('--accent-rgb','88,255,154')},.58)`,1.7,false);strokePath([[1.56,.05,-.72],[2.18,-.03,-.62],[2.46,-.06,-.34]],amber,2,false);strokePath([[1.56,.05,.72],[2.18,-.03,.62],[2.46,-.06,.34]],amber,2,false);strokePath([[2.12,-.09,-.55],[2.5,-.07,-.38],[2.5,-.07,.38],[2.12,-.09,.55]],`rgba(${css('--accent2-rgb','56,216,255')},.72)`,2.2,false)}
